...
public class AdminMainFrm extends JFrame {
	...
	public AdminMainFrm() {
		...
		JMenuItem mntmNewMenuItem_4 = new JMenuItem("查询/修改学生信息");
		...
		mntmNewMenuItem_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminCptItemAddInterFrm cptItemAddInterFrm = new AdminCptItemAddInterFrm();
		...
		JMenuItem mntmNewMenuItem_2 = new JMenuItem("查询/修改赛项信息");
		...
		mntmNewMenuItem_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminCptAddInterFrm adminCptAddInterFrm = new AdminCptAddInterFrm();
		...
		JMenuItem mntmNewMenuItem_6 = new JMenuItem("查询/修改竞赛信息");
		...
		JMenu mnNewMenu_4 = new JMenu("获奖管理");
		SysMng.add(mnNewMenu_4);
		
		JMenuItem mntmNewMenuItem_7 = new JMenuItem("设置队伍获奖等级");
		mnNewMenu_4.add(mntmNewMenuItem_7);
		
		JMenuItem mntmNewMenuItem_8 = new JMenuItem("查询/修改队伍获奖等级");
