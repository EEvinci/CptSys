...
public class AdminCntRwdStuInfoCptInterFrm extends JInternalFrame {
	...
	public AdminCntRwdStuInfoCptInterFrm() {
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"\u6240\u5C5E\u8D5B\u9879", "\u7ADE\u8D5B\u540D\u79F0", "\u83B7\u5956\u7B49\u7EA7", "\u5B66\u53F7", "\u5B66\u751F\u59D3\u540D", "\u961F\u4F0D\u7F16\u53F7", "\u4E13\u4E1A", "\u5E74\u7EA7", "\u73ED\u7EA7"
			}
		) {
		...
		CptNameTxt.setBounds(171, 23, 202, 34);
		getContentPane().add(CptNameTxt);
		...
		JLabel 竞赛编号 = new JLabel("获奖等级");
		竞赛编号.setFont(new Font("宋体", Font.BOLD, 23));
		竞赛编号.setBounds(435, 28, 111, 27);
		getContentPane().add(竞赛编号);
		
		CptIdTxt = new JTextField();
		CptIdTxt.setColumns(10);
		CptIdTxt.setBounds(546, 23, 202, 34);
	...
	private void CptRwdInfoSearchActionPerformed(ActionEvent e) {
		...
		String cptItemId = this.CptIdTxt.getText();
		BeanCptInfo cptInfo = new BeanCptInfo();
		cptInfo.setCptName(cptName);
		cptInfo.setHoldYear(cptItemId);
