...
public class AdminMainFrm extends JFrame {
	...
	public AdminMainFrm() {
		...
		JMenuItem mntmNewMenuItem_7 = new JMenuItem("添加队伍");
		...
		JMenuItem mntmNewMenuItem_8 = new JMenuItem("查询/修改/删除队伍");
		...
		SrchCptAwd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminQueryCptRwdInterFrm AdminQueryCptRwdInterFrm = new AdminQueryCptRwdInterFrm();
		...
		CptBased.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminCntRwdStuInfoCptInterFrm AdminCntRwdStuInfoCptInterFrm = new AdminCntRwdStuInfoCptInterFrm();	
