...
public class Stu_LogOnFrm_1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Stu_LogOnFrm_1 frame = new Stu_LogOnFrm_1();
	...
	public Stu_LogOnFrm_1() {
		...
		CptRegiSys.setIcon(new ImageIcon(Stu_LogOnFrm_1.class.getResource("/cn/zucc/edu/images/2542800.png")));
		...
		AdminLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Ad_LogOnFrm adLogOnFrm = new Ad_LogOnFrm();
	...
	private void loginActionPerformed(ActionEvent e) {
		...
		try {
			...
			{
				dispose();
				new Stu_MainFrm().setVisible(true);
			}
			else
