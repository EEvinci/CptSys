...
public class AdminRUDCptInterFrm extends JInternalFrame {
	...
	public AdminRUDCptInterFrm() {
		...
		CptInfoTable.setModel(new DefaultTableModel(
			...
			new String[] {
				"\u7ADE\u8D5B\u7F16\u53F7", "\u6240\u5C5E\u8D5B\u9879\u7F16\u53F7", "\u7ADE\u8D5B\u540D\u79F0", "\u4E3E\u529E\u671F\u5C4A", "\u4E3E\u529E\u5E74\u4EFD", "\u4E3E\u529E\u65F6\u95F4", "\u62A5\u540D\u5F00\u59CB\u65F6\u95F4", "\u62A5\u540D\u7ED3\u675F\u65F6\u95F4", "\u8054\u7CFB\u8001\u5E08", "\u7ADE\u8D5B\u5B98\u7F51"
			}
		));
		CptInfoTable.getColumnModel().getColumn(1).setPreferredWidth(119);
	...
	private void CptInfoUpdateActionPerformed(ActionEvent evt) {
		// TODO 自动生成的方法存根
		String cptItemId = textField.getText();
		String cptId = textField_1.getText();
