...
public class AdminRUDCptItemInterFrm extends JInternalFrame {
	...
	public AdminRUDCptItemInterFrm() {
		...
		CptItemNumTxt.setBounds(104, 59, 66, 21);
		...
		textField.setBounds(278, 61, 66, 21);
		...
		ResPersonTxt.setBounds(462, 59, 66, 21);
		...
		BelongColTxt.setBounds(650, 60, 66, 21);
		...
		CptLevelTxt.setBounds(838, 60, 66, 21);
