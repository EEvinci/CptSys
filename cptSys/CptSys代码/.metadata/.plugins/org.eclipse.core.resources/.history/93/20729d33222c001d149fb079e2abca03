...
public class AdminRUDTeamInterFrm extends JInternalFrame {
	...
	public AdminRUDTeamInterFrm() {
		...
		textField.setBounds(104, 59, 66, 21);
		panel.add(textField);
		...
		textField_1.setBounds(278, 61, 66, 21);
		...
		textField_2.setBounds(462, 59, 66, 21);
		...
		textField_3.setBounds(650, 60, 66, 21);
		...
		textField_4.setBounds(838, 60, 66, 21);
